...
parser = argparse.ArgumentParser(description='compare N50 and max contig statistics of file1.fasta and file2.fasta, move lower quality assembly to Hel', usage="fastaN50_JudgementSort.py filepath1/file1.assembly.fasta filepath2/file2.assembly.fasta --outDir hell_path/fasta_hell --minLength 500(default)")
...
logger = logging.getLogger("fastaN50_JudgementSort.py")
